#to call the constructor of parent class through the

#if more than one parent is there, again MRO will be applied i.e based on how we declare in class.
...
class Child(Parent):  #we have added the Parent here from which the child is going to be inherent
    def __init__(self):
        ...
        super().__init__() # this calls the parent constructor
    def child_method(self):
        print("This is the Child Method")
        super().parent_method() # this calls the parent method
